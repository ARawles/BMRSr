...
* `format`
    + The format of the content of the respose (i.e. did you ask for a "csv" or "xml"?)
* `clean_dates`
...
* `clean_date_columns()`
    + This function will attempt to auto-convert columns in the provided daaframe/tibble to the correct type. Often, the API will return date/time/datetime columns as plain text, and so this function will try to convert the type based on the column heading. This doesn't always work...
